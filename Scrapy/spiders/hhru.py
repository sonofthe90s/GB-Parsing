...
class HhruSpider(scrapy.Spider):
    ...
    def vacancy_parse(self, response:HtmlResponse):
        ...
        company_job = response.css('span.bloko-section-header-2.bloko-section-header-2_lite::text').extract()
        ...
        # print(name_job, salary_job)
        yield JobparserItem(name=name_job, company=company_job, salary_min=salary_job_min, salary_max=salary_job_max,
                            currency=currency_job)
